...
const companies = [
  ...
  {
    id: 2,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsYxhoVGQgaG9RT-aQk4SsPdG_TtKgmUsjYw&s",
    alt: "Oracle",
  },
  {
    id: 3,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPBss61ZSzmBM75JqdYCVqsfqJ4JijX0mt9g&s",
    alt: "IBM",
  },
  {
    id: 4,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL2a418p8twUZDZKHOggy9fkZSrnxyUZw6Bg&s",
    alt: "Wipro",
  },
  {
    id: 5,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTPAWYqoR1E-YMPwd869I0X2WuToOjTrPXgQ&s",
    alt: "TCS",
  },
  {
    id: 6,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5KDGIGNftKhASVxmkWMKjaQi2Bhk8Gg4m0g&s",
    alt: "Cognizant",
  },
  {
    id: 7,
  ...
  {
    id: 8,
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFL1WTbNfc8y2sztRRsC9G4VFaHdGkWaf89w&s",
    alt: "Infosys",
  },
];
    ...
    <div className="py-10">
      ...
      <div className="flex flex-wrap justify-center">
        {companies.map((company) => (
          <div
            key={company.id}
            className="flex justify-center w-1/4 p-4 mb-2 md:w-1/4 sm:w-1/2 xs:w-1/3"
          >
            <img
              src={company.src}
              alt={company.alt}
...
const foundedCompanies = [
  {
    id: "1",
    src: "https://media.licdn.com/dms/image/v2/D4D0BAQHdJj1mvZZPNw/company-logo_200_200/company-logo_200_200/0/1700468976898/idiosys_technologies_logo?e=2147483647&v=beta&t=sPgEf861LGm4cN2U0ZoQhegMLwdIUb9LyIqfpwSZ2-8",
    alt: "Idiosys",
  },
  {
    id: "2",
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBkPdreYcfXHlJtimiJALomo1XGIDm0rxKJg&s",
    alt: "PAS DIGITAL",
  },
  {
    id: "3",
    src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgCDyevhGid1n_hG8_6bOo7bC-_kxb4h00_Q&s",
    alt: "PAS DIGITAL ACADEMY",
  },
];
...
const Testimonial = () => {
  ...
  return (
    <div className="py-10 px-5">
      <h2 className=" text-gray-400 text-center text-2xl font-bold mb-6">
        Testimonial
      </h2>
...
const Footer = () => {
  return (
    <footer className="bg-customColor text-gray-300 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-sm">
              VUCS Alumni is a platform for alumni to connect, grow, and
              celebrate achievements together. Join us to stay connected and
              make a difference.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                Email:{" "}
                <a
                  href="mailto:info@vucsalumni.com"
              ...
              <li>
                Address: Vidyasagar University, Medinipur, West Bengal, India
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} VUCS Alumni. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
